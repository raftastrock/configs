...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drYYo", function() { return drYYo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
// This file was automatically generated from pro-tips.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace drYYo.
 * @public
 */

goog.module('drYYo.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param277 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Always, always, always favor ');
          ie_open('strong');
            itext('readability');
          ie_close('strong');
          itext('.  If it is a bottleneck to perf come back and fix it later');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('strong');
          itext('Stability');
        ie_close('strong');
        itext(' is something you want to keep in mind when picking an algo');
      ie_close('p');
      ie_open('h3');
        itext('Algos are all about ');
        ie_open('strong');
          itext('tradeoffs');
        ie_close('strong');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('strong');
            itext('Pro Tip');
          ie_close('strong');
          itext('  If you cannot see the variable on the same page, "redeclare it" so the reader knows exactly what scope it belongs to');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'drYYo.render';
}
...
class drYYo extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(drYYo, templates);
...
var _proTipsSoy = __webpack_require__(92);

var _proTipsSoy2 = _interopRequireDefault(_proTipsSoy);
...
var drYYo = function (_Component) {
  _inherits(drYYo, _Component);

  function drYYo() {
    _classCallCheck(this, drYYo);

    return _possibleConstructorReturn(this, (drYYo.__proto__ || Object.getPrototypeOf(drYYo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(drYYo, _proTipsSoy2.default);

exports.default = drYYo;
