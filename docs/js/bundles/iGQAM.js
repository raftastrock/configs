...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iGQAM", function() { return iGQAM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace iGQAM.
 * @public
 */

goog.module('iGQAM.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param380 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Linux, Mac, and Android are based on ideas and specs of ');
          ie_open('em');
            itext('UNIX');
          ie_close('em');
        ie_close('p');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Started as an os at AT&T in the 60s');
        ie_close('li');
        ie_open('li');
          itext('Unix was originally built for large ');
          ie_open('em');
            itext('mainframe computers');
          ie_close('em');
          itext(' that people would use at the same time');
        ie_close('li');
        ie_open('li');
          itext('Every program on UNIX system read input from ');
          ie_open('em');
            itext('standard input devide (stdin)');
          ie_close('em');
          itext(' and write to ');
          ie_open('em');
            itext('standard output (stdout)');
          ie_close('em');
          ie_open('ul');
            ie_open('li');
              itext('The big idea is that rather than type everything yourself, you can have the computer ');
              ie_open('strong');
                itext('type for you');
              ie_close('strong');
            ie_close('li');
            ie_open('li');
              itext('There were terminals and you ran your commands which "printed out" your stuff to an actual printer');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
      ie_close('ul');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('UNIX still matters because it is still portable to many kinds of hardware');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul');
        ie_open('li');
          ie_open('strong');
            itext('Introduction to Bash, VIM & Regex');
          ie_close('strong');
          ie_open('ul');
            ie_open('li');
              itext('wifi routers');
            ie_close('li');
            ie_open('li');
              itext('dsl and cable modems');
            ie_close('li');
            ie_open('li');
              itext('raspberry pi, beaglebone, nvidia, jetson');
            ie_close('li');
            ie_open('li');
              itext('android phones');
            ie_close('li');
            ie_open('li');
              itext('linux laptop or desktop');
            ie_close('li');
            ie_open('li');
              itext('Mac OSX computer');
            ie_close('li');
            ie_open('li');
              itext('Web server');
            ie_close('li');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('A set of principles of how programs should relate to each other');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul');
        ie_open('li');
          itext('each program should do one thing well');
        ie_close('li');
        ie_open('li');
          itext('the ');
          ie_open('strong');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'iGQAM.render';
}
...
class iGQAM extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(iGQAM, templates);
...
var iGQAM = function (_Component) {
  _inherits(iGQAM, _Component);

  function iGQAM() {
    _classCallCheck(this, iGQAM);

    return _possibleConstructorReturn(this, (iGQAM.__proto__ || Object.getPrototypeOf(iGQAM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iGQAM, _indexSoy2.default);

exports.default = iGQAM;
