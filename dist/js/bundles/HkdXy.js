...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HkdXy", function() { return HkdXy; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace HkdXy.
 * @public
 */

goog.module('HkdXy.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param391 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      ie_open('h2');
        itext('Integrating Metal in the Liferay context');
      ie_close('h2');
      ie_open('blockquote');
        ie_open('p');
          itext('It is recommended to integrate metal at the ');
          ie_open('em');
            itext('OSGI');
          ie_close('em');
          itext(' level although you could do it from a theme level and potentially a web content level');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul');
        ie_open('li');
          ie_open('p');
            itext('In relation to that keep an eye on ');
            ie_open('strong');
              itext('page fragments');
            ie_close('strong');
            itext(' that Jorge Ferrer is working on which may facilitate this');
          ie_close('p');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            ie_open('strong');
              itext('Loop Faro');
            ie_close('strong');
            itext(' are good examples for microsites');
          ie_close('p');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            itext('Metal is only really helpful when you have ');
            ie_open('strong');
              itext('dynamic content');
            ie_close('strong');
          ie_close('p');
          ie_open('ul');
            ie_open('li');
              itext('For static content it is not useful');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            itext('Soy is only possibly on ');
            ie_open('strong');
              itext('server side');
            ie_close('strong');
            itext('; better for ');
          ...
          ie_open('ul');
            ie_open('li');
              itext('At this point it is not ideal to render JSX on Java server or have like Node servlets rendering and passing it on to Java');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            itext('Talk to Travis about ');
            ie_open('strong');
              itext('workspaces');
            ie_close('strong');
          ie_close('p');
        ...
        ie_open('li');
          ie_open('p');
            ...
            ie_open('strong');
              itext('generator cli');
            ie_close('strong');
            itext(' rather than building things out in Liferay context');
          ie_close('p');
        ie_close('li');
      ie_close('ul');
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HkdXy.render';
}
...
class HkdXy extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HkdXy, templates);
...
var HkdXy = function (_Component) {
  _inherits(HkdXy, _Component);

  function HkdXy() {
    _classCallCheck(this, HkdXy);

    return _possibleConstructorReturn(this, (HkdXy.__proto__ || Object.getPrototypeOf(HkdXy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HkdXy, _indexSoy2.default);

exports.default = HkdXy;
