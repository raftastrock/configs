...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FfEzl", function() { return FfEzl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
// This file was automatically generated from scoping.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace FfEzl.
 * @public
 */

goog.module('FfEzl.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param288 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Block scopes have curly braces');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul');
        ie_open('li');
          ie_open('p');
            itext('Kyle Simpson recommends using ');
            ie_open('code');
              itext('var');
            ie_close('code');
            itext(' most of the time, then ');
            ie_open('code');
              itext('let');
            ie_close('code');
            itext(', then ');
          ...
          ie_open('ul');
            ie_open('li');
              itext('He doesn\'t use ');
              ie_open('code');
                itext('const');
              ie_close('code');
              itext(' to declare functions only uses ');
              ie_open('code');
                itext('const');
              ie_close('code');
              itext(' for immutable objects');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            ie_open('strong');
              itext('const');
            ie_close('strong');
            itext(' implies a constant');
          ie_close('p');
          ie_open('ul');
            ie_open('li');
              itext('means it never is ');
              ie_open('em');
                itext('reassigned');
              ie_close('em');
            ie_close('li');
            ie_open('li');
              itext('the problem of using const is that it confuses readers because a lot of people still think that a "constant" doesn\'t change');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function diff(x,y) {\n  if (x > y) {\n    let tmp = x \n    x = y\n    y = tmp\n  }\n\n  return y - x\n}', mode: 'javascript'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          ie_open('p');
            ie_open('strong');
          ...
          ie_open('ul');
            ie_open('li');
              itext('If you try to access ');
              ie_open('code');
                itext('tmp');
              ie_close('code');
              itext(' outside of the ');
              ie_open('strong');
                itext('if block');
              ie_close('strong');
              itext(' you will get a ');
              ie_open('em');
                itext('reference error');
              ie_close('em');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            ie_open('code');
              itext('let');
            ie_close('code');
            itext(' is always better used in a ');
            ie_open('code');
              itext('for loop');
            ie_close('code');
          ie_close('p');
        ...
        ie_open('li');
          ie_open('p');
            ie_open('code');
              itext('let');
            ie_close('code');
            itext(' cannot be redeclared but ');
            ie_open('code');
              itext('var');
            ie_close('code');
            itext(' can be redeclared');
          ie_close('p');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function repeat(fn, n) {\n  var result;\n\n  for (let i = 0; i < n; i ++) {\n    result = fn( result, i)\n  }\n\n  return result\n}', mode: 'javascript'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          ie_open('code');
            itext('var');
          ie_close('code');
          itext(' is better used when you want to stylistically signal to the reader that ');
          ie_open('code');
            itext('result');
          ie_close('code');
          itext(' in this case is going to be used throughout the function');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function lookupRecord(searchStr) {\n  try {\n    var id = getRecord(searchStr)\n  }\n  catch (err) {\n    var id = -1\n  }\n\n  return id\n}', mode: 'js'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('By using ');
          ie_open('code');
            itext('var');
          ie_close('code');
          itext(' here you escape the block scope and can reference the variable');
        ie_close('li');
      ie_close('ul');
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('h2');
        itext('Function Scoping');
      ie_close('h2');
      $templateAlias2({code: 'var foo = \'foo\'\n\nfunction bob(0 {\n  var foo = \'foo2\'\n  console.log(foo) // \'foo2\'\n})\nbob()\n\nconsole.log(foo) // \'foo\' phew!', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
        itext('IIFE (immediately invoked function expression) Pattern');
      ie_close('h2');
      ie_open('blockquote');
        ie_open('p');
          itext('If you don\'t want to pollute the name space, but you want to ');
          ie_open('strong');
            itext('create scope and you only want your function to run once');
          ie_close('strong');
          itext(', the IIFE pattern is helpful');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul');
        ie_open('li');
          itext('This is similar to ');
          ie_open('strong');
            itext('block scoping');
          ie_close('strong');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'var foo = \'foo\'\n\n(function IIFE(bar) {\n  var foo = \'foo2\'\n  console.log(foo) // \'foo2\'\n})(foo)\n\nconsole.log(foo) // \'foo\'', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'FfEzl.render';
}
...
class FfEzl extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(FfEzl, templates);
...
var _scopingSoy = __webpack_require__(93);

var _scopingSoy2 = _interopRequireDefault(_scopingSoy);
...
var FfEzl = function (_Component) {
  _inherits(FfEzl, _Component);

  function FfEzl() {
    _classCallCheck(this, FfEzl);

    return _possibleConstructorReturn(this, (FfEzl.__proto__ || Object.getPrototypeOf(FfEzl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FfEzl, _scopingSoy2.default);

exports.default = FfEzl;
