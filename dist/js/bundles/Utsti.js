...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Utsti", function() { return Utsti; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace Utsti.
 * @public
 */

goog.module('Utsti.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param266 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('I am not content, nor should you be, at stopping once something just works, and not really knowing why. I gently challenge you to journey down that bumpy "');
          ie_open('em');
            itext('road less traveled');
          ie_close('em');
          itext('" and embrace all that JavaScript is and can do. With that knowledge, no ');
          ie_open('strong');
            itext('technique');
          ie_close('strong');
          itext(', no ');
          ...
          ie_open('strong');
            itext('buzzword');
          ie_close('strong');
          itext(' acronym of the week, will be beyond your understanding. ~Kyle Simpson');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'Utsti.render';
}
...
class Utsti extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(Utsti, templates);
...
var Utsti = function (_Component) {
  _inherits(Utsti, _Component);

  function Utsti() {
    _classCallCheck(this, Utsti);

    return _possibleConstructorReturn(this, (Utsti.__proto__ || Object.getPrototypeOf(Utsti)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Utsti, _indexSoy2.default);

exports.default = Utsti;
