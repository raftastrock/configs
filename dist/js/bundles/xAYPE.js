...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "xAYPE", function() { return xAYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace xAYPE.
 * @public
 */

goog.module('xAYPE.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param230 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      ie_open('h2');
        itext('Big O Notation');
      ie_close('h2');
      ie_open('p');
        ie_open('a', null, null,
            'href', 'https://postimg.org/image/x3n81brp5/');
          ie_open('img', null, null,
              'src', 'https://s20.postimg.org/arpf7xsl9/bigocheatsheet.png',
              'alt', 'bigocheatsheet.png');
          ie_close('img');
        ie_close('a');
      ie_close('p');
      ie_open('p');
        ie_open('a', null, null,
            'href', 'https://postimg.org/image/hjfuashkp/');
          ie_open('img', null, null,
              'src', 'https://s20.postimg.org/w2mzc7app/array_Big_O.png',
              'alt', 'array_Big_O.png');
          ie_close('img');
        ie_close('a');
      ie_close('p');
      ...
      ie_open('h4');
        itext('TODO: ');
        ie_open('a', null, null,
            'href', 'https://web.njit.edu/~wl256/download/cs610/Introduction-to-algorithm-3rdEdition.pdf');
          itext('Read this');
        ie_close('a');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Big O sucks away the unimportant stuff so you can focus on what matters');
        ie_close('p');
      ie_close('blockquote');
      ie_open('h3');
        itext('O(1)');
      ...
      ie_open('ul');
        ie_open('li');
          itext('When you have no loops and are just doing something and exiting/returning');
        ie_close('li');
      ie_close('ul');
      ie_open('h3');
        itext('O(n)');
      ...
      ie_open('ul');
        ie_open('li');
          itext('When you are doing the same amount of work that is going into a function');
        ie_close('li');
      ie_close('ul');
      ie_open('h3');
        itext('O(n^2)');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Trick here is to look for double ');
          ie_open('code');
            itext('for');
          ie_close('code');
          itext(' or ');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Where code employs ');
          ie_open('strong');
            itext('divide and conquer');
          ie_close('strong');
          itext(' strategies that use ');
          ie_open('em');
            itext('recursion');
          ie_close('em');
          itext(' like merge and quick sorts');
        ie_close('li');
      ie_close('ul');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_close('code');
      ie_close('p');
      $templateAlias2({code: 'function bubbleSort(nums) {  \n  do {\n    var swapped = false\n    \n    for (let i = 0; i < nums.length; i++) {\n      if (nums[i] > nums[i + 1] {\n        const temp = nums[i]\n        nums[i] = nums[i + 1]\n        nums[i + 1] = temp\n        swapped = true\n      }\n    }\n  } while(swapped)\n}', mode: 'javascript'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          itext('You probably will never use a do loop or bubble sort in production code');
        ie_close('li');
      ie_close('ul');
      ie_open('h3');
        itext('Insertion Sort');
      ie_close('h3');
      ie_open('p');
        ie_open('code');
          itext('bigO = n ^ 2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Has more favorable coefficients than bubble sort');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function insertionSort(nums) {\n  for (let i = 1; i < nums.length; i++) {\n    for (let j = 0; j < i; j++) {\n      if (nums[i] < nums[j]) {\n        const spliced = nums.splice(i, 1)\n        nums.splice(j, 0, spliced[0])\n      }\n    }\n  }\n}', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('strong');
            itext('base case');
          ie_close('strong');
          itext(' is the most important piece.  If you don\'t write this first you will stack overflow');
        ie_close('p');
      ie_close('blockquote');
      $templateAlias2({code: 'function basicRecursion(max, current) {\n  if (current > max) return\n  console.log(current)\n  basicRecursion(max, current + 1)\n}\n\nbasicRecursion(1, 10)', mode: 'js'}, null, opt_ijData);
      ie_open('h3');
        itext('Fibonacci Sequences');
      ie_close('h3');
      ie_open('p');
        ie_open('code');
          itext('1, 1, 2, 3, 5, 10');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Fibonacci sequences lends itself well to recursion because they are themselves defined ');
          ie_open('strong');
            itext('recursively');
          ie_close('strong');
          ie_open('ul');
            ie_open('li');
              itext('You need to know the ');
              ie_open('strong');
                itext('first two preceeding');
              ie_close('strong');
              itext(' terms to get the nth number of the sequence');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function fibonacci(n) {\n  if (n <= 2) return 1\n  \n  return fibonacci(n - 1) + fibonacci(n - 2)\n}', mode: 'javascript'}, null, opt_ijData);
      ie_open('h3');
        itext('Factorials');
      ie_close('h3');
      ie_open('p');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Factorials are defined recursively by ');
          ie_open('strong');
            itext('multiplying itself');
          ie_close('strong');
          itext(' by the previous number until you get to 1');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'function factorial(n) {\n  if (n < 2) return 1\n  \n  return n * function factorial(n) {\n  if (n < 2) return 1\n  \n  return n * factorial(n - 1)\n}', mode: 'javascript'}, null, opt_ijData);
      ie_open('h3');
        itext('Merge Sort');
      ie_close('h3');
      ie_open('p');
        ie_open('code');
          itext('bigO = O(n log n)');
        ie_close('code');
      ie_close('p');
      ie_open('ul');
        ie_open('li');
          itext('Recursive algo that is very ');
          ie_open('strong');
            itext('stable');
          ie_close('strong');
          ie_open('ul');
            ie_open('li');
              itext('However when sorting numbers stability doesn\'t matter because you don\'t care what order two 4\'s for instance are given to you');
            ie_close('li');
          ie_close('ul');
        ie_close('li');
      ie_close('ul');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'xAYPE.render';
}
...
class xAYPE extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(xAYPE, templates);
...
var xAYPE = function (_Component) {
  _inherits(xAYPE, _Component);

  function xAYPE() {
    _classCallCheck(this, xAYPE);

    return _possibleConstructorReturn(this, (xAYPE.__proto__ || Object.getPrototypeOf(xAYPE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xAYPE, _indexSoy2.default);

exports.default = xAYPE;
