...
var _ElectricCodeTabs = __webpack_require__(22);
...
var _ElectricReadingProgress = __webpack_require__(24);

var _ElectricReadingProgress2 = _interopRequireDefault(_ElectricReadingProgress);

var _ElectricSearch = __webpack_require__(25);

var _ElectricSearch2 = _interopRequireDefault(_ElectricSearch);

var _ElectricSearchAutocomplete = __webpack_require__(26);
...
var _ElectricUpdates = __webpack_require__(27);
...
var _Align = __webpack_require__(51);
...
var _metalUri = __webpack_require__(64);
...
function $olderPosts(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
        'class', 'container');
      var childIdList33 = opt_data.site.index.children['blog'].childIds;
      var childIdListLen33 = childIdList33.length;
      for (var childIdIndex33 = 0; childIdIndex33 < childIdListLen33; childIdIndex33++) {
        var childIdData33 = childIdList33[childIdIndex33];
        var childPage__soy21 = opt_data.site.index.children['blog'].children[childIdData33];
        if (opt_data.page.url != childPage__soy21.url) {
          ie_open('div', null, null,
              'class', 'post-item container-blog');
            ie_open('a', null, null,
                'class', 'post-item__link',
                'href', childPage__soy21.url);
              ie_open('small');
                itext('By ');
                var dyn4 = childPage__soy21.author;
                if (typeof dyn4 == 'function') dyn4(); else if (dyn4 != null) itext(dyn4);
                itext(' ');
                ie_open('span');
                  itext('| ');
                  var dyn5 = childPage__soy21.date;
                  if (typeof dyn5 == 'function') dyn5(); else if (dyn5 != null) itext(dyn5);
                ie_close('span');
              ie_close('small');
              ie_open('h4', null, null,
                  'class', 'post-item__title');
                var dyn6 = childPage__soy21.title;
...
var _ElectricAPIAutocomplete = __webpack_require__(28);
...
var _metalClipboard = __webpack_require__(44);
...
var _metalTooltip = __webpack_require__(61);
...
var _metalTabs = __webpack_require__(59);
...
var _metalAffix = __webpack_require__(41);
...
var _metalReadingProgress = __webpack_require__(52);
...
var _ElectricCode = __webpack_require__(30);
...
var _ElectricNavigation = __webpack_require__(32);
...
var _ElectricReadingProgress = __webpack_require__(34);
...
var _ElectricSearch = __webpack_require__(36);
...
var _ElectricUpdates = __webpack_require__(40);
...
var _metalDebounce = __webpack_require__(45);
...
var _ListSoy = __webpack_require__(48);
...
var _ListItemSoy = __webpack_require__(50);
...
var _ReadingProgress = __webpack_require__(53);
...
var _ReadingProgressTracker = __webpack_require__(54);
...
var _metalScrollspy = __webpack_require__(55);
...
var _MultiMap = __webpack_require__(56);
...
var _TabsSoy = __webpack_require__(60);
...
var _metalKeyboardFocus = __webpack_require__(46);
...
var _TooltipBase2 = __webpack_require__(63);

var _TooltipBase3 = _interopRequireDefault(_TooltipBase2);

var _TooltipSoy = __webpack_require__(62);
...
var _metalStructs = __webpack_require__(58);
...
var _parseFromAnchor = __webpack_require__(66);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VbMFR", function() { return VbMFR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace VbMFR.
 * @public
 */

goog.module('VbMFR.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param335 = function() {
    ...
    ie_open('article', null, null,
        'id', '1');
      ie_open('h2');
        itext('Adding GitHub name and email in the global config');
      ie_close('h2');
      $templateAlias2({code: 'git config --global user.name "John Doe"\ngit config --global user.email johndoe@example.com', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('h2');
        itext('Change Default Terminal');
      ie_close('h2');
      $templateAlias2({code: 'sudo chsh -s $(which zsh)', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '3');
      ie_open('h2');
        itext('How to install a .deb file');
      ie_close('h2');
      $templateAlias2({code: 'sudo dpkg -i /path/to/deb/file', mode: 'shell'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '4');
      ie_open('h2');
        itext('Change Having to type password on Sudo command');
      ie_close('h2');
      ie_open('p');
        itext('Open terminal window and type:');
      ie_close('p');
      $templateAlias2({code: 'sudo visudo', mode: 'text'}, null, opt_ijData);
      ie_open('p');
        itext('In the bottom of the file, type the follow:');
      ie_close('p');
      $templateAlias2({code: 'username ALL=(ALL) NOPASSWD: ALL', mode: 'text'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '5');
      ie_open('h2');
      ...
      ie_open('ul');
        ie_open('li');
          itext('Permissions are granted with:');
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: 'chmod a+x filename', mode: 'text'}, null, opt_ijData);
      ie_open('p');
        itext('If you run a ');
        ie_open('code');
          itext('ls -l');
        ie_close('code');
        itext(' in the cli you will get a list of files and folders with a string at the front like so:');
      ie_close('p');
      ie_open('ul');
        ie_open('li');
          itext('-rw-rw-r--');
          ie_open('ul');
            ie_open('li');
              itext('The first space will be blank for a file but ');
              ie_open('code');
                itext('d');
              ie_close('code');
              itext(' if it is a ');
            ...
            ie_close('li');
            ie_open('li');
              itext('The next three spaces represent permissions for ');
              ie_open('strong');
                itext('current user');
              ie_close('strong');
            ie_close('li');
            ie_open('li');
              itext('The next three ');
              ie_open('strong');
                itext('groups');
              ie_close('strong');
            ie_close('li');
      ...
      ie_open('ul');
        ie_open('li');
          itext('So when running ');
          ie_open('code');
            itext('a+x');
          ie_close('code');
          itext(' you are saying to make file executable for all users');
        ie_close('li');
      ie_close('ul');
    ie_close('article');
    ie_open('article', null, null,
        'id', '6');
      ie_open('h2');
        itext('How to Remap Keys in Ubuntu');
      ie_close('h2');
      ie_open('ul');
        ie_open('li');
          itext('This approach relies upon a program to listen for keys events and then dispatching the key combo you want using a virtual keybard');
        ie_close('li');
      ie_close('ul');
      ie_open('ol');
        ie_open('li');
          ie_open('code');
            itext('sudo apt install xvkbd');
          ie_close('code');
          itext(' This is the virtual keyboard');
        ie_close('li');
        ie_open('li');
          ie_open('code');
            itext('sudo apt install xbindkeys');
          ie_close('code');
          itext(' This is the listener');
        ie_close('li');
        ie_open('li');
          ie_open('code');
            itext('sudo apt install xbindkeys-config');
          ie_close('code');
          itext(' This is the listener gui');
        ie_close('li');
      ie_close('ol');
      ie_open('ul');
        ie_open('li');
          itext('The data goes into your ');
          ie_open('code');
            itext('.xbindkeysrc');
          ie_close('code');
          itext(' file in your home dir');
        ie_close('li');
      ie_close('ul');
      ie_open('p');
        itext('Here is an example:');
      ie_close('p');
      $templateAlias2({code: '#Select Left\n"xvkbd -xsendevent -text "\\C\\S\\[Left]""\n    Control+Shift+Mod2+Mod5 + j\n\n#Select Right\n"xvkbd -xsendevent -text "\\C\\S\\[Right]""\n    Control+Shift+Mod2+Mod5 + l', mode: 'bash'}, null, opt_ijData);
      ie_open('ul');
        ie_open('li');
          ie_open('p');
            itext('The above simply listens for the meta key + control + shift and sends a select left and select right text command with the virtual keyboard');
          ie_close('p');
        ie_close('li');
        ie_open('li');
          ie_open('p');
            itext('After modifying your ');
            ie_open('code');
              itext('.xbindkeysrc');
            ie_close('code');
            itext(' file you must kill the xbindkeys process with ');
            ie_open('code');
              itext('pkill -9 xbindkeys');
            ie_close('code');
            itext(' and then rerun it with ');
            ie_open('code');
              itext('xbindkeys');
            ie_close('code');
          ie_close('p');
          ie_open('ul');
            ie_open('li');
              itext('If you want to verify it is running you can do ');
              ie_open('code');
                itext('pgrep xbindkeys');
              ie_close('code');
              itext(' which will output the ');
              ie_open('strong');
                itext('pid');
              ie_close('strong');
            ie_close('li');
    ...
    ie_open('article', null, null,
        'id', '7');
      ie_open('h2');
        itext('How to unzip a tar file');
      ie_close('h2');
      $templateAlias2({code: 'tar -zxvf file', mode: 'text'}, null, opt_ijData);
      ie_open('h3');
        itext('How to unzip a gz file');
      ie_close('h3');
      $templateAlias2({code: 'gunzip < file.gz > file', mode: 'text'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'VbMFR.render';
}
...
class VbMFR extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(VbMFR, templates);
...
var _actionsSoy = __webpack_require__(95);

var _actionsSoy2 = _interopRequireDefault(_actionsSoy);
...
var VbMFR = function (_Component) {
  _inherits(VbMFR, _Component);

  function VbMFR() {
    _classCallCheck(this, VbMFR);

    return _possibleConstructorReturn(this, (VbMFR.__proto__ || Object.getPrototypeOf(VbMFR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VbMFR, _actionsSoy2.default);

exports.default = VbMFR;
